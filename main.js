...
chrome.runtime.onInstalled.addListener(function(details) {
	if(details.reason == "install") {
		chrome.storage.sync.set({bgim: "Images/GradientOrangeToRed.png", 
...
function constructNewBookmark(bm , i) {
	...
	bmdiv.addEventListener("mouseenter", function() {
		//position = i;
		bmoptval = parseInt((this.id)[5] + ((this.id).length >= 7 ? ((this.id).length == 8 ? (this.id)[6] + (this.id)[7] : (this.id)[6]) : ""),10);
	...
	bmlinkdiv.addEventListener("resize", function() {
		bmval = parseInt((this.id)[5] + ((this.id).length >= 7 ? ((this.id).length == 8 ? (this.id)[6] + (this.id)[7] : (this.id)[6]) : ""),10);
		document.getElementById("bmlinkdiv" + bmval).style.width = trueleft.style.width;
	});
	del.addEventListener("click", function() {
		bmoptval = parseInt((this.id)[3] + ((this.id).length >= 5 ? ((this.id).length == 6 ? (this.id)[4] + (this.id)[5] : (this.id)[4]) : ""),10);
	...
	bmopdiv.addEventListener("click", function() {
		let bmoptval = parseInt((this.id)[7] + ((this.id).length >= 9 ? ((this.id).length == 10 ? (this.id)[8] + (this.id)[9] : (this.id)[8]) : ""),10);
	...
	moveup.addEventListener("click", function() {
		bmoptval = parseInt((this.id)[6] + ((this.id).length >= 8 ? ((this.id).length == 9 ? (this.id)[7] + (this.id)[8] : (this.id)[7]) : ""),10);
	    	let str = "" , str1 = "";
	...
	movedown.addEventListener("click", function() {
		bmoptval = parseInt((this.id)[8] + ((this.id).length >= 10 ? ((this.id).length == 11 ? (this.id)[9] + (this.id)[10] : (this.id)[9]) : ""),10);
	    	let str = "" , str1 = "";
	    	bml0 = document.getElementById("bmlink" + bmoptval);
	    	bml1 = document.getElementById("bmlink" + (bmoptval + 1));
